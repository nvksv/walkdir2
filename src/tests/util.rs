...
use crate::fs::{self, FsPath, FsPathBuf};
...
#[derive(Debug)]
pub struct RecursiveResults<E: fs::FsDirEntry> {
    ents: Vec<DirEntry<E>>,
    errs: Vec<Error<E>>,
}

impl<E: fs::FsDirEntry> RecursiveResults<E> {
...
impl Dir {
    ...
    pub fn run_recursive<I, E: fs::FsDirEntry>(&self, it: I) -> RecursiveResults<E>
    where
