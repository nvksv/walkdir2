...
[docs.rs/walkdir2](https://docs.rs/walkdir2/)
...
```rust,no_run
use walkdir2::{DirEntry, WalkDir, ClassicWalkDirIter};
...
performance difference after running `find /`, `walkdir2 /` and `nftw /` on my
